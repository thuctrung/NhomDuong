    ...
    <div className="container">
      <div className="row">
          ...
          <div className="col-md-3">
            ...
            <img src="img/i5.jpg" style={{width:'240px',height:'240px',marginTop:'60px',marginLeft:'30px'}}></img>
          </div>
          <div className="col-md-3">
            <img src="img/i1.jpg" style={{width:'240px',height:'300px' ,marginTop:'100px', marginLeft:'60px'}}></img>
           </div>
          </div>
        </div> 
      </div>
